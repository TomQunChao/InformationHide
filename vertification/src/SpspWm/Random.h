...
public:
	Random();
	double extract();
	double extract(double low, double high);
};

class Mt19937:public Random {
private:
...
class GgdGen:public Random {
private:
	Mt19937* m1, * m2;
	ExpGen* e1, * e2, * e3;
	double getBeta(double sigmax,double c);
public:
